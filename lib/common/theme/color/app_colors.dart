...
class AppColors {
  static const Color primary = Color.fromRGBO(253, 126, 20, 1);
  static const Color primaryLight = Color.fromRGBO(253, 126, 20, 1);
  static const Color secondary = Color.fromARGB(255, 242, 159, 88);
